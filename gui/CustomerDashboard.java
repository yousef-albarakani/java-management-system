...
public class CustomerDashboard extends JFrame {
    ...
    public CustomerDashboard(Customer customer) {
        ...
        setTitle("APU Automotive — Customer Dashboard");
        setSize(1000, 660);
        ...
        JLabel lblSub = new JLabel("WELCOME, " + customer.getName().toUpperCase());
        ...
        String[][] cards = {
            ...
            {"Service History", "Check your past appointments"},
            {"Payment History", "View your payment records"},
            {"View Feedback", "Check technician feedback"},
            {"Add Comment", "Comment on staff / technician"},
            {"Book Info", "See your service details"}
        };
    ...
    private void openCustomerScreen(String title) {
        if (title.equals("Edit Profile")) {
            new CustomerProfileFrame(customer);
        } else if (title.equals("Service History")) {
            new ServiceHistoryFrame(customer);
        } else if (title.equals("Payment History")) {
            new PaymentHistoryFrame(customer);
        } else if (title.equals("View Feedback")) {
            new CustomerFeedbackFrame(customer);
        } else if (title.equals("Add Comment")) {
            new AddCommentFrame(customer);
        } else if (title.equals("Book Info")) {
            new BookingInfoFrame(customer);
        }
    }
    ...
    private JButton createCardButton(String title, String desc) {
        JButton btn = new JButton() {
...

            {
                ...
                addActionListener(e -> openCustomerScreen(title));
            }
        ...
        JPanel p = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                g2.setPaint(new GradientPaint(
                        0, cy, new Color(212, 175, 55, 0),
                        cx - 10, cy, new Color(212, 175, 55, 80)
                ));
                g2.setStroke(new BasicStroke(0.8f));
                ...
                g2.setPaint(new GradientPaint(
                        cx + 10, cy, new Color(212, 175, 55, 80),
                        getWidth(), cy, new Color(212, 175, 55, 0)
                ));
